  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen p-4 bg-slate-50 dark:bg-[#0b1021] transition-colors duration-500">
      ...
      <div className="w-full max-w-md mx-auto p-8 border border-slate-200 dark:border-white/10 bg-white/85 dark:bg-slate-800/50 rounded-2xl shadow-xl backdrop-blur">
        <h2 className="text-3xl font-extrabold text-center text-slate-900 dark:text-white mb-2">DeepWave</h2>
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mb-6">
          Sign in to access your AI wellness studio.
        </p>
        <h3 className="text-2xl font-medium text-center text-slate-900 dark:text-white mb-6">Login</h3>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-slate-600 dark:text-gray-300">Password</label>
            <input
              type="password"
              id="password"
              value={password}
